...
func.func @test_basic(%arg0: tensor<1x12x384xf32>, %arg1: tensor<1x384x384xf32>, %arg2: tensor<1x1x384xf32>, %arg3: tensor<1x12x384xf32>) -> tensor<1x12x1xf32> {
    %188 = "tosa.matmul"(%arg0, %arg1) {perf_config = "64,16,8,16,16,4,1,1"} : (tensor<1x12x384xf32>, tensor<1x384x384xf32>) -> tensor<1x12x384xf32>
    %189 = "tosa.add"(%188, %arg2) : (tensor<1x12x384xf32>, tensor<1x1x384xf32>) -> tensor<1x12x384xf32>
    %190 = "tosa.add"(%189, %arg3) : (tensor<1x12x384xf32>, tensor<1x12x384xf32>) -> tensor<1x12x384xf32>
    %191 = "tosa.reduce_sum"(%190) {axis = 2 : i64} : (tensor<1x12x384xf32>) -> tensor<1x12x1xf32>
    return %191 : tensor<1x12x1xf32>
}
