...
func.func @test_basic(%arg0: tensor<1x256x768xf32>, %arg1: tensor<1x768x768xf32>, %arg2: tensor<1x1x768xf32>, %arg3: tensor<1x256x768xf32>) -> tensor<1x256x1xf32> {
    %188 = "tosa.matmul"(%arg0, %arg1) {perf_config = "64,16,8,16,16,4,1,1"} : (tensor<1x256x768xf32>, tensor<1x768x768xf32>) -> tensor<1x256x768xf32>
